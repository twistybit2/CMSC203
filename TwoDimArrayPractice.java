   ...
   */
   public void printArray( )
   {
    ...
    // Write your code here:
	   ...
	   for (int x = 0; x<intArray.length;x++) { //Loop for the rows
		   for (int y = 0; y<intArray[x].length; y++) { //For the columns
   ...
   */
   public void setValues( int value, int row )
   {
    ...
    // Write your code here:
	   ...
	   for(int i=0; i<intArray[row].length;i++) { //Traverse the row
		   intArray[row][i] = value; //Set to value
		   animate (row,i); //Animate it
	   }
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	   ...
	   for (int j=0; j<4; j++) {
		   if (intArray[j][column] <= min) {
			   min = intArray[j][column];
		   }
		   animate (j, column, min);
	   }
   ...
   */
   public int countFound( int value )
   {
    ...
    // Write your code here:
	   ...
	   for (int x = 0; x < intArray.length; x++) { //Row
		   for (int y = 0; y < intArray[x].length; y++) { //Column
			   
			   if (intArray[x][y] == value) count++;
			   animate( x, y, count );
		   }
	   }
